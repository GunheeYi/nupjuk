...
var settings = {
    ...
    overrideLightCheck: false,
    overrideDarkCheck: false,
    lightLight: "#37671b",
    lightDark: "#254512",
    lightDarker: "#1c340e",
    darkLighter: "#333333",
    ...
    compactViewCheck: true,
    panelButtonCheck: true,
    cleanNotificationCheck: true,
    readNotificationCheck: true,
    weekAllCheck: true,
    enterToWeekCheck: true,
    studentListCheck: true,
    weekSliderCheck: true,
    courseHeightRadios: "full",
    courseHeight: 500,
    // downloadCheck: false,
    language: "kor",
    themeRadios: "olive"
...
function getTheme(themeName){
    for (t of themes) if (t.name == themeName) return t;
    return undefined;
}

const settingsKeys = Object.keys(settings);
const inputs = settingsKeys.filter(key => ["language", "themeName"].indexOf(key) < 0 );
const dependencies = {
    darkAtNightCheck: [],
    overrideLightCheck: ["lightLight", "lightDark", "lightDarker"],
    overrideDarkCheck: ["darkLighter", "darkLight", "darkDark", "darkDarker", "darkFontLight", "darkFontDark"],
    ...
    readNotificationCheck: [],
    weekAllCheck: [],
    enterToWeekCheck: [],
    studentListCheck: [],
    weekSliderCheck: [],
    courseHeightCustom: ["courseHeight"],
    // downloadCheck: [],
}
...
function pageIs(name) {
    ...
    switch (name) {
        case "klms":
            return href.startsWith("https://klms.kaist.ac.kr/");
        case "main":
            return href == "https://klms.kaist.ac.kr/";
        case "room":
